			  ...
			  html += '<div class="motd-box pt-0 bg-black noselect hide" id="motd-2">';
					...
					html += '<div class="motd-pages">';
						...
						html += '<div class="motd-page hide" data-page="menu">';
							...
							html += '<p>';
								html += '<ul>';
									html += '<li>Station du maraîcher - Légumes de saison en crudités, craquelins maison, hummus et trempettes</li>';
									html += '<li>Charcuteries en folies - saucissons bio de Charlevoix, jambon cru, fraises, melons, salade d’herbes</li>';
								html += '</ul>';
							html += '</p>';
							html += '<p><h4>Entrées</h4></p>';
							html += '<p>';
								html += '<ul>';
									html += '<li>Tartelette aux légumes grillés - Fromage, tomates, courgettes vinaigrette</li>';
									html += '<li>Tomates de Fardoche - Haloumi grillé de St-Robert, pesto du jardin, pousses, crumble à la fleur d’ail</li>';
								html += '</ul>';
							html += '</p>';
							html += '<p><h4>Soupe</h4></p>';
							html += '<p>';
								html += '<ul>';
									html += '<li>Crème de courgettes, sumac et herbes fraîches</li>';
								html += '</ul>';
							html += '</p>';
							html += '<p><h4>Résistance</h4></p>';
							html += '<p>';
								html += '<ul>';
									html += '<li>Filet de porc sirop-whiskey-piment goria écrasé de pommes de terre à l’ail grillé, lime et gingembre</li>';
									html += '<li>Blanc de volaille citron-oregano sauce chimichurri et légumes du marché</li>';
								html += '</ul>';
							html += '</p>';
							html += '<p><h4>Dessert</h4></p>';
							html += '<p>';
								html += '<ul>';
									html += '<li>Feuilleté d’été fraises au sirop de mélilot, crème chiboust et fleurs</li>';
								html += '</ul>';
								html += '*Café, thé et infusion inclus';
							html += '</p>';
							html += '<p><h3>Enfant</h3></p>';
							html += '<p><h4>Entrees</h4></p>';
							html += '<p>';
								html += '<ul>';
									html += '<li>Soupe, Crème de courgettes, sumac et herbes fraîches</li>';
								html += '</ul>';
							html += '</p>';
							html += '<p><h4>repas</h4></p>';
							html += '<p>';
								html += '<ul>';
									html += '<li>Pates</li>';
									html += '<li>Pizza du chef</li>';
								html += '</ul>';
							html += '</p>';
							html += '<p><h4>Dessert</h4></p>';
							html += '<p>';
